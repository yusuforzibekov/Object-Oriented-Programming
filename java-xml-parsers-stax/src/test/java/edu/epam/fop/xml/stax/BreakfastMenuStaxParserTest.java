...
class BreakfastMenuStaxParserTest {

	@ParameterizedTest
	@CsvFileSource(resources = "/foods-test-data.csv", numLinesToSkip = 1)
	void testStaxParser(int index, String expectedId, String expectedName, String expectedPrice,
		...
		List<Food> foodList = BreakfastMenuStaxParser.parseBreakfastMenu(xmlUrl.getFile());
